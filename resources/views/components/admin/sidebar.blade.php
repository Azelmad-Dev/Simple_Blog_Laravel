<aside class="w-64 h-full bg-gray-800">
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 px-2 py-4 space-y-1">
            ...
            <a href="{{ route('admin.posts.of_authenticated_admin') }}"
                class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg {{ request()->routeIs('admin.posts.of_authenticated_admin') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
